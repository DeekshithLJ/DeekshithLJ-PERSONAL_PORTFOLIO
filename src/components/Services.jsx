  ...
  return (
    <div 
      ...
      className={`w-72 sm:w-80 rounded-[2rem] p-2 relative flex flex-col items-center hover:scale-[1.02] transition-all duration-700 z-10 ${className} ${
        isActive ? 'bg-[#8b0000] border-[#ff6b6b] shadow-[0_20px_50px_rgba(139,0,0,0.4)]' : 'bg-black/40 backdrop-blur-xl border border-white/10 shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.4)]'
      }`}
    >
      {/* The hole punch */}
...
const Services = () => {
  ...
  return (
    <section 
      id="services"
      ref={containerRef}
      className="bg-transparent pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans"
    >
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          <div className="inline-block border border-white/40 rounded-full px-5 py-1.5 text-sm text-white font-bold mb-8 shadow-sm bg-[#8b0000]/60 backdrop-blur-md">
            My Work
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] mb-6 tracking-tight relative">
            ...
            {/* Hand-drawn arrow */}
            <svg className="absolute -bottom-10 right-10 w-12 h-12 text-[#8b0000]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-gray-300 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            A selection of my recent work in web development, AI, and machine learning, demonstrating my technical skills and problem-solving abilities.
          </p>
        </div>
        ...
        >
          ...
          <path 
            ...
            strokeDasharray="8 10" 
            mask="url(#path-mask)"
            className="drop-shadow-[0_0_10px_rgba(139,0,0,0.8)]"
          />
        </svg>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            ...
            text="Real-time system using Python and OpenCV for eye-blink detection to improve road safety via continuous monitoring."
          ...
          <TagCard 
            ...
            text="Web-based fashion store built with Java, React.js, and MySQL. Features responsive UI, product management, and data handling."
          ...
          <TagCard 
            ...
            text="Automated screening tool analyzing candidate resumes against job requirements using React, Flask, Scikit-Learn, and NLP."
          ...
          <TagCard 
            ...
            text="Tap Academy intern (Feb-Jun 2026). Implemented backend logic, integrated MySQL, and built responsive React interfaces."
          ...
          <div 
            data-aos="fade-in" 
            data-aos-delay="600"
            className="hidden md:block absolute top-[1250px] left-[60%] font-['Caveat',cursive] text-3xl text-gray-300 rotate-6"
          >
